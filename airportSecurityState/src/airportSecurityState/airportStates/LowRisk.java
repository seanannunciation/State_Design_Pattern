...
/**
 *This class defines the LowRisk state
 * @author annse
 */
public class LowRisk implements airportStateI {
	...
	AirportContextState astate;
         ...
         * @param asI 
         */
	public LowRisk(AirportContextState asI){
		astate=asI;
                r=astate.getResult();
                MyLogger.writeMessage("Inside LowRisk Constructor", MyLogger.DebugLevel.CONSTRUCTOR);
	}
	/**
