...
/**
 *This class is used to define the HighRisk state 
 * @author annse
 */   
	...
	/**
         ...
         * @param asI 
         */
	public HighRisk(AirportContextState asI){
		astate=asI;
                r=astate.getResult();
                MyLogger.writeMessage("Inside HighRisk Constructor", MyLogger.DebugLevel.CONSTRUCTOR);
